  ...
  return (
    ...
    >
      <div className="max-w-md bg-opacity-80 p-4 rounded-lg ml-32 mt-16">
        <h2 className="flex items-center gap-2 text-sm font-bold  xxxs:relative xxxs:right-16 xxxs:bottom-20">
        <img src="/images/105.svg" alt="Logo" className="w-4 h-4" />
        Get The App
      </h2>
        <h2 className="text-[40px] font-bold mb-2 xxxs:relative xxxs:right-16 xxxs:bottom-20 xxxs:text-[32px] xxxs:w-[300px]">Download the 
          SimFree app now!</h2>
        <p className="mb-4 xxxs:relative xxxs:right-16 xxxs:bottom-20 ">
