...
const ExploreDestinations = () => {
  ...
  <button
    ...
    className="flex items-center justify-center gap-x-2 text-gray-400 px-4 py-1 rounded-full mb-4 text-sm font-medium w-24 sm:mr-[620px]"
  >
    ...
    Explore
            ...
            <h1 className="text-5xl font-extrabold text-gray-900 leading-tight">
              <span className="block sm:mr-[540px]">Explore</span>
              
       
              <span className="block lg:pl-6 sm:mr-44 sm:-mt-14 md:ml-48 md:-mt-14">Global</span>
              
              <span className="block sm:mr-[420px]">Destinations</span>
            </h1>

            <p className="text-gray-600 sm:mr-[344px] sm:w-[390px] text-md w-[307px] mt-4 md:w-[600px] md:ml-1">
          ...
          <div className="mt-10 md:mt-0 flex justify-center md:justify-end w-full md:w-auto">
            <img
              ...
              className="max-w-sm object-contain w-[340px] h-[269px] 
                        ...
                        -rotate-6 lg:w-72 lg:h-60 md:w-60 md:h-48 md:ml-0 md:mt-0 sm:w-52 sm:h-40 sm:-mt-56 sm:ml-[500px]"
            />
          </div>
        </div>
      </div>
